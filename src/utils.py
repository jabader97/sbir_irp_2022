...
def get_datasets(args):
    ...
    train_loader = DataLoader(dataset=data_train, batch_size=args.batch_size, num_workers=args.num_workers,
                              pin_memory=True)
    train_loader_sketch = DataLoader(dataset=data_train_sketch, batch_size=args.batch_size, shuffle=False,
    ...
    test_loader_image = DataLoader(dataset=data_test_image, batch_size=args.batch_size, shuffle=False,
                                    num_workers=args.num_workers, pin_memory=True)
    return train_loader, train_loader_sketch, valid_loader_sketch, valid_loader_image, test_loader_sketch, test_loader_image, \
